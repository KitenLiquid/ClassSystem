			   ...
			   <tr>
			  	<td colspan="8">
			  		...
			  		<c:if test="${pageBean.currentPage !=1 }">
			  			<a href="/ClassSystem/SearchStudentServlet?currentPage=1">首页</a>
						| <a href="/ClassSystem/SearchStudentServlet?currentPage=${pageBean.currentPage-1 }">上一页</a>
			  		</c:if>
			  		...
			  		<c:forEach begin="1" end="${pageBean.totalPage }" var="i">
			  			...
			  			<c:if test="${pageBean.currentPage != i }">
			  				<a href="/ClassSystem/SearchStudentServlet?currentPage=${i }">${i }</a>
			  			</c:if>
			  		...
			  		<c:if test="${pageBean.currentPage !=pageBean.totalPage }">
			  			<a href="/ClassSystem/SearchStudentServlet?currentPage=${pageBean.currentPage+1 }">下一页</a> | 
			  			<a href="/ClassSystem/SearchStudent Servlet?currentPage=${pageBean.totalPage }">尾页</a>
			  		</c:if>
			  	</td>
			  </tr>
		  </table>
